(function () {
  ...
  var STRINGS = {
    ko: {
      ...
      'chip.brand': '브랜드',
      'chip.urban': '도시·공공',
      'tag.productOwner': 'product owner',
      'tag.productDesign': 'product design',
      'tag.founderDesign': 'founder / design',
      'tag.businessPlanning': 'business planning',
      ...
      'work.muda': 'AI 음악 추천 일기앱 MUDA. PO로서 기획·UX 방향·텀블벅 펀딩을 총괄했고, 266% 달성(62명, 130만 원+)에 기여했습니다.',
      'work.pairchive': '둘이서 한 달간 링크를 모아 책을 완성하는 페어링 웹 서비스. Figma 로고·UI 설계부터 프론트엔드 구현까지 전 과정을 담당했습니다.',
      'work.strawberryfields': '영주 STAXX Strawberry Fields 편집숍. 100일간 8개 로컬 브랜드 큐레이션 — 사업 기획부터 매장·프로그램 운영까지 전담했습니다.',
      'work.impactsquare': '영주 STAXX Strawberry Fields 편집숍. 100일간 8개 로컬 브랜드 큐레이션 — 사업 기획부터 매장·프로그램 운영까지 전담했습니다.',
    ...
    en: {
      ...
      'stack.viewProjects': 'view projects',
      'work.viewProject': 'View Project',
      'work.muda': 'MUDA — AI music diary app. Led as PO: planning, UX direction, and Tumblbug crowdfunding (266%, 62 backers, ₩1.3M+).',
      ...
      'work.strawberryfields': 'Strawberry Fields edit shop at STAXX Yeongju. Business planning and operations for an 8-brand, 100-day curation.',
      'work.impactsquare': 'Strawberry Fields edit shop at STAXX Yeongju. Business planning and operations for an 8-brand, 100-day curation.',
